...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    private Wrapper<SysRole> buildQueryWrapper(SysRole role) {
        ...
        wrapper.eq("r.del_flag", UserConstants.ROLE_NORMAL)
            ...
            .likeRight(StringUtils.isNotBlank(role.getRoleName()), "r.role_name", role.getRoleName())
            .eq(StringUtils.isNotBlank(role.getStatus()), "r.status", role.getStatus())
            .likeRight(StringUtils.isNotBlank(role.getRoleKey()), "r.role_key", role.getRoleKey())
