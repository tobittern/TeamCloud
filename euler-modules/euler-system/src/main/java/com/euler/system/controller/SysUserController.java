...
import com.euler.system.domain.vo.SysUserExportVo;
import com.euler.system.domain.vo.SysUserImportVo;
...
import com.euler.common.excel.core.ExcelResult;
...
import com.euler.system.listener.SysUserImportListener;
    ...
    public R<Void> add(@Validated @RequestBody SysUser user) {
        if (UserConstants.NOT_UNIQUE.equals(userService.checkUserNameUnique(user.getUserName()))) {
            ...
            return R.fail("新增用户'" + user.getUserName() + "'失败，手机号码已存在");
                ...
                && UserConstants.NOT_UNIQUE.equals(userService.checkEmailUnique(user.getEmail()))) {
    ...
    public R<Void> edit(@Validated @RequestBody SysUser user) {
        ...
        if (StringUtils.isNotEmpty(user.getPhonenumber())
            ...
            return R.fail("修改用户'" + user.getUserName() + "'失败，手机号码已存在");
                ...
                && UserConstants.NOT_UNIQUE.equals(userService.checkEmailUnique(user.getEmail(),user.getUserId()))) {
