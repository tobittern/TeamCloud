...
public class DiyRechargeStatVo {
    /**
     * 日期id
     */
     ...
     * 充值平台币金额
     */
    @ExcelProperty(value = "充值平台币金额")
    @ApiModelProperty("充值平台币金额")
     ...
     * 游戏充值金额
     */
    @ExcelProperty(value = "游戏充值金额")
    @ApiModelProperty("游戏充值金额")
    private String gameCurrency = "0";

    /**
     * 年费充值金额
     */
    @ExcelProperty(value = "年费充值金额")
    @ApiModelProperty("年费充值金额")
    private String yearCurrency = "0";
