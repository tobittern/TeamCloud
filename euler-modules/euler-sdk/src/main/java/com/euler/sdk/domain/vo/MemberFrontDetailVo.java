 ...
 */
@Data
@ApiModel("前端会员详细信息视图对象")
@ExcelIgnoreUnannotated
public class MemberFrontDetailVo {
     ...
     * 是否有未读消息 0：没有 1：有
     */
    @ApiModelProperty(value = "是否有未读消息 0：没有 1：有")
    private String isRead;

    /**
     * true:需要补充密码,false:不需要补充密码
     */
    @ApiModelProperty(value = "true:需要补充密码,false:不需要补充密码")
