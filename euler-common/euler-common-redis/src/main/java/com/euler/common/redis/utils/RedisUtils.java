...
public class RedisUtils {
    ...
    public static <T> T getCacheObject(final String key) {
        ...
        T ss = rBucket.get();
        if (ss != null && (ss instanceof String && ss == ""))
            return null;
        return ss;
     ...
     * @return 缓存的对象
     */
    public static <T> boolean setCacheList(final String key, List<T> dataList) {
        RList<T> rList = CLIENT.getList(key);
        if (dataList == null || dataList.isEmpty())
            dataList = new ArrayList<>();

        rList.expire(Duration.ofMinutes(Constants.BASE_EXPIRE_TIME));
     ...
     * @return 缓存的对象
     */
    public static <T> boolean setCacheList(final String key, List<T> dataList, final Duration duration) {
        RList<T> rList = CLIENT.getList(key);
        if (dataList == null || dataList.isEmpty())
            dataList = new ArrayList<>();
    ...
    public static <T> boolean setCacheSet(final String key, final Set<T> dataSet) {
        ...
        rSet.expire(Duration.ofMinutes(Constants.BASE_EXPIRE_TIME));
    ...
    public static <T> void setCacheMap(final String key, final Map<String, T> dataMap) {
        if (dataMap != null) {
            ...
            rMap.expire(Duration.ofMinutes(Constants.BASE_EXPIRE_TIME));
