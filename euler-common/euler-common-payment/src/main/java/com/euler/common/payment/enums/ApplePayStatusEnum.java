...
public enum ApplePayStatusEnum {
     ...
     * 交易不存在
     */
    TRADE_NOT_EXIST(6,"ACQ.TRADE_NOT_EXIST"),
    ...
    public static ApplePayStatusEnum find(String value) {
        for (ApplePayStatusEnum enumd : values()) {
            if (enumd.getCode().equals(value)) {
                return enumd;
            }
        }
        log.info("ApplePayStatusEnum未找到：{}",value);
        return null;
    }
}
