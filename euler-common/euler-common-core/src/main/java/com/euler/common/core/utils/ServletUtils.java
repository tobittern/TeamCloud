...
public class ServletUtils extends ServletUtil {
    ...
    public static HttpServletRequest getRequest() {
        try {
            ...
            return EmptyServletRequest.getEmptyRequest();
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public static HttpServletResponse getResponse() {
        try {
            ...
            return EmptyServletRequest.getEmptyRespone();
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public static String getClientIP() {
        ...
        ip = StringUtils.isNotBlank(ip) && ip.contains("0:0:0:0:0:0:0:1") ? "127.0.0.1" : ip;
