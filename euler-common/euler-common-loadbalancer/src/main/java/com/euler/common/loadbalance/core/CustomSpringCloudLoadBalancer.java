...
public class CustomSpringCloudLoadBalancer implements ReactorServiceInstanceLoadBalancer {
    ...
    private Response<ServiceInstance> getInstanceResponse(List<ServiceInstance> instances) {
        ...
        ServiceInstance ins=instances.get(ThreadLocalRandom.current().nextInt(instances.size()));
        //log.info("springcloud:choose:reqHost:{},lbHost:{}",ins.getHost(),LoadBalancerConstant.getHost());
